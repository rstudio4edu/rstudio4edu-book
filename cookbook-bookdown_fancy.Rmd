...
You may have noticed that the horizontal line from the toolbar and the TOC do not match up perfectly. This CSS fixes that:
...
2. **Paste** in the following: 
    ...
    ```
3. **Save and Build** your book to see how it looks.
...
<!-- Thought: could refer folks to use Bookdown theme Editor Addin. However, using this will generate a `style.css` that will override any other existing css in root directory. Also, generates messy CSS, so hard to edit later.  -->
