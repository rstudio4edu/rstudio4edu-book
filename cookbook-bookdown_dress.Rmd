...
By default bookdown numbers all of your headings. If you don't like this, then you have to de-number the manually. **Within any `.Rmd`** you can do this if you:
...
1. **Open** `_output.yml`.
1. Add a `sharing:` field and set `github: yes`, `facebook: no`, `twitter: yes`, `all: no`.
