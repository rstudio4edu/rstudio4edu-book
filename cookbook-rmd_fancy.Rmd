...
I'm making a few assumptions that by this point you have already updated your R Markdown site with your own content in the [Make it yours](#rmd-yours) section and added whatever built-in options
...
2. Select the font you want by clicking on the upper red `+` sign, and navigate to the small pop up window. 
    ...
    ```{r rmd-select-font, echo = FALSE, out.width="100%", fig.cap= "Selecting a Google font"}
...
3. Click on the `CUSTOMIZE` tab, and select the extra font weights and styles you want. Don't check any that you don't think you'll use (because it slows down your lesson's loading time ever-so-slightly when you add more). In addition to regular, I'm choosing one italic and one bold. 
    ...
    ```{r rmd-font-customize, echo = FALSE, out.width="100%", fig.cap="Choosing additional font weights and styles"}
...
4. Now click on `EMBED` and look under the `@IMPORT` tab. **Copy the code within the `<style>` tags** (you don't need the style tags themselves). We will also need the second code chunk in a couple steps that says `Specify in CSS`, so keep this page open to come back to that.
    ...
    ```{r rmd-googleimport, echo = FALSE, out.width="100%", fig.cap="Getting the script to import your Google Font"}
...
knitr::include_graphics("images/screenshots/hero-decode.jpg")
```
...
1. Add `border: none;` as a new line in this style rule.
  ...
  <!-- TODO new screenshot -->
    ...
    knitr::include_graphics("images/screenshots/doc-toc-no-border.png")
    ```
...
<!-- TODO new screenshots -->
    ...
    ```{r, echo = FALSE, out.width="50%"}
    knitr::include_graphics("images/screenshots/doc-toc-links.png")
    ```
...
**Before**
    ```{r, echo = FALSE, out.width="100%"}
    knitr::include_graphics("images/screenshots/doc-exercises-before.png")
    ```
...
**After**
    ```{r, echo = FALSE, out.width="100%"}
    knitr::include_graphics("images/screenshots/doc-exercises-after.png")
    ```
...
<div class="footer"> 
  ...
  <p class="rstudio4edu-footer">This site was created with an <a class="rstudio4edu" href="https://rstudio4edu.github.io/rstudio4edu-book/"> <img class="footer logo" src="logo-mark-rstudio4edu.png"> rstudio4edu</a> template.</p>
