...
1. For every chapter you can download the `.Rmd` source file that created it by clicking on the download button in the upper toolbar. 

1. The button to the left allows you to edit (say more about how this works). 

1. Clicking on the GitHub icon on the far right takes you to the source repository for this book. 
