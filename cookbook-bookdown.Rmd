...
**Note**: In the example above, we can use specify any kind image file (e.g. PNG), but real favicons are special images files with `.ico` extensions. Luckily bookdown takes care of converting this for us if we don't give it an `.ico` file to begin with in the index YAML.
:::
