...
Let's take our demo Distill site for a course and make it fancier, by doing a bit more customization with the CSS.
...
While I'm here, I'll also change the body's text color to be more of an off-black. 

:::tip
Choosing colors that are not at the complete extreme of the color spectrum (pure black or pure white), gives you some room 
