...
(why, how, pros and cons of each)
   - **distill**: Pros: looks clean and classy by default. Cons: Certain features of an R Markdown site are not available, though (code_download, highlight, code_folding). Built-in ways to presenting technical content (equations, references, and cross-referencing less effortful).
