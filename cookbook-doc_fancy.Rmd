...
1. But this leaves our logo squished up at the top of our page--so let's adjust our earlier style rule that we used for our logo, by increase its top `margin` to `2.75em` also. When a margin has four numbers, the first value applies to the top.
...
<div class="side-by-side">
  ...
  <div class="side2">
    ...
    knitr::include_graphics("images/screenshots/doc-space-toc-body.png")
...
* enclose your list items that you want to be exercise questions with special `<div class="question">` `</div>` tags.
