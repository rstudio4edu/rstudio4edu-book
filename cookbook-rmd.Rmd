...
This is a step you will do a lot as you build your site. What does this do? This processes your `.Rmd`s and creates the `docs/` folder (if it doesn't already exist) that houses `.html` pages of your `.Rmd` files. AND each of these pages now has a navigation bar at the top that links your site together (this is thanks to our `_site.yml` file--but more on that later).
...
:::tip
Note: Editing your `.Rmd` files and then pushing to GitHub are steps you'll do *many* times as you build up your content. Working with your `_site.yml` file is usually something you only mess with intially as you set up your site.
...
If these customizations leave you wanting more, then be sure to check out the "Make it fancy" tutorial in the next chapter.
