...
From within the RStudio IDE, you can also access a *"Markdown Quick Reference"* from the **Help** menu.
...
Let your code chunks breathe! Bonus: it improves the readability of your narrative. This is unfortunately a bit manual. But--if you don't plan on doing any CSS, then we highly recommend doing the below:
