...
R Markdown is a powerful tool that seems relatively simple when you first start using R: you focus mainly on your words (written in [Markdown](https://commonmark.org/help/tutorial/)) and your code (written in <i class="fab fa-r-project"></i>), which seem basic enough! But...then you start trying to use R Markdown to create educational content that will be consumed by learners. 
